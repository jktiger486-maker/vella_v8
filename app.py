...
CFG = {
    ...
    # --------------------------------------------------------
    "05_EXECUTION_MIN_PRICE_MOVE_PCT": 0.25,  # 후보 대비 최소 하락 %
    ...
    # --------------------------------------------------------
    "15_SL_PCT": 0.80,          # 손절
    # [변경] 0.60 → 0.80 (노이즈 견딜 여유 확보)
    "16_TP1_PCT": 1.5,         # TP1 트리거
    # [변경] 0.70 → 1.50 (짧게 먹고 나오지 말고 길게 가져감)
    "17_TP_PARTIAL_PCT": 0.50,  # TP1 부분익절 비율
    "18_PULLBACK_PCT": 0.8,    # 단일 FINAL EXIT 되돌림 %
    # [변경] 0.45 → 0.80
    # 이유: 0.45는 너무 좁습니다. 하락장에서도 기술적 반등은 나옵니다.
    # 이걸 0.8로 넓혀야 큰 추세를 끝까지 발라먹을 수 있습니다.
